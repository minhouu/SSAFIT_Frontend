      ...
      <fieldset class="form-control mb-3">
        <div class="mb-3">
          ...
          <div class="row p-2">
            ...
            <div class="col-2 d-flex justify-content-center">
              <button class="btn btn-primary btn-sm m-2" v-if="videoStore.isEditor" @click="changeEditing">수정하기</button>
              <button class="btn btn-primary btn-sm m-2" v-if="videoStore.isEditor"
                @click="videoStore.deleteVideo()">삭제하기</button>
            </div>
          </div>
        </div>
